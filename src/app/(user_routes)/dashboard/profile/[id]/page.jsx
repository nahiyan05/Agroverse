  ...
  if (isLoading) {
    return (
      <div className="max-w-7xl mx-auto p-4 sm:p-6 min-h-screen">
        ...
        <div className="bg-linear-to-br from-green-50 to-green-100 dark:from-slate-800 dark:to-slate-900 rounded-xl p-6 border border-green-200 dark:border-slate-700 shadow-lg dark:shadow-2xl mb-6">
